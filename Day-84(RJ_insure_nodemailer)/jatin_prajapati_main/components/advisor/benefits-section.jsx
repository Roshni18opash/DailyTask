...
export function BenefitsSection() {
  ...
  return (
    <section id="benefits" className="py-12 md:py-16 relative overflow-hidden bg-background/30" ref={ref}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {benefits.map((benefit, index) => (
            ...
            >
              <div className="absolute -inset-1 bg-gradient-to-b from-primary/20 to-transparent rounded-[2rem] blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              <div className="bg-card/40 backdrop-blur-xl rounded-[2rem] border border-white/5 p-6 h-full flex flex-col items-center text-center relative z-10 transition-all duration-500 hover:border-primary/30 shadow-2xl">
                <div className="flex-1 flex flex-col items-center">
                  <div className="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                    <benefit.icon className="w-6 h-6 text-primary" />
                  </div>
                  <h3 className="text-lg font-black text-foreground mb-3 tracking-tight leading-tight uppercase">
                    {benefit.title}
                  </h3>
                ...
                <div className="relative w-full max-w-[180px] aspect-square mx-auto mt-auto bg-white/5 rounded-2xl p-4 overflow-hidden group-hover:bg-white/10 transition-colors">
